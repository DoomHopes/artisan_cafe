    ...
    return Scaffold(
      ...
      body: brewsAsync.when(
        ...
        data: (brews) {
          ...
          final todayBrews = brews.where((b) => b.createdAt.year == today.year && b.createdAt.month == today.month && b.createdAt.day == today.day).toList();
          final totalCaffeine = todayBrews.fold<int>(0, (sum, brew) => sum + brew.caffeine);
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            latestBrew.name.isNotEmpty ? latestBrew.name : 'Custom Drink',
                            style: Theme.of(context).textTheme.headlineMedium?.copyWith(fontSize: 24),
                          ),
                          Text(
                            DateFormat('MMMM d, h:mm a').format(latestBrew.createdAt),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        LinearProgressIndicator(
                          ...
                          backgroundColor: AppColors.secondaryContainer,
                          color: totalCaffeine > 400 ? AppColors.error : AppColors.primary,
                          borderRadius: BorderRadius.circular(4),
                          minHeight: 4,
                        ),
                      ],
